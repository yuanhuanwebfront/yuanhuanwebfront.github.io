import{q as f,A as p,aC as c,aD as s,B as o,v as u,x,y as v,k as b,D as C,z as d,F as $}from"./index-Y23ghTge.js";const w=i=>{const{textColor1:t,dividerColor:n,fontWeightStrong:l}=i;return{textColor:t,color:n,fontWeight:l}},_={name:"Divider",common:f,self:w},y=_,z=p("divider",`
 position: relative;
 display: flex;
 width: 100%;
