import{q as f,A as p,aC as c,aD as d,B as o,v as u,x as v,y as x,k as b,D as C,z as s,F as $}from"./index-BRXRnVT_.js";const w=i=>{const{textColor1:t,dividerColor:n,fontWeightStrong:l}=i;return{textColor:t,color:n,fontWeight:l}},_={name:"Divider",common:f,self:w},y=p("divider",`
 position: relative;
 display: flex;
 width: 100%;
